...
public class Editorial_WhyWeTravel extends testBase {
    ...
    @Test(dependsOnMethods = {"create_EditorialSubTemplate_WhyWeTravel"})
    ...
    @Test(dependsOnMethods = {"create_EditorialSubTemplate_WhyWeTravel"}, dataProvider = "readTestData")
    public void Verify_And_Feed_AuthorProfile_Content_Section(Hashtable<String, String> data) throws InterruptedException, IOException {
    ...
    @Test(dependsOnMethods = {"create_EditorialSubTemplate_WhyWeTravel"}, dataProvider = "readTestData")
    public void Verify_PreFeeded_EditoriaQuotes_Add_SubComponent_And_Feed_Content_Section(Hashtable<String, String> data) throws InterruptedException, IOException {
    ...
    @Test(dependsOnMethods = {"create_EditorialSubTemplate_WhyWeTravel"}, dataProvider = "readTestData")
    public void Verify_PreFeeded_GridMediaFolder_Add_SubComponent_And_Feed_Content_Section(Hashtable<String, String> data) throws InterruptedException, IOException {
    ...
    @Test(dependsOnMethods = {"create_EditorialSubTemplate_WhyWeTravel"}, dataProvider = "readTestData")
    public void Verify_PreFeeded_FeaturedBrand_Add_SubComponent_And_Feed_Content_Section(Hashtable<String, String> data) throws InterruptedException, IOException {
    ...
    public Object[][] getData(Method method) throws IOException {
        ...
        } else if (method.getName().equals("Verify_And_Feed_AuthorProfile_Content_Section")) {
            // return DataUtil.getData(xls, "TemplateName", testSheetName);
            return GDriveSpreedSheetUtil.getTestDataFromExcel("Verify_And_Feed_AuthorProfile_Content_Section", testSheetName);

        } else if (method.getName().equals("Verify_PreFeeded_EditoriaQuotes_Add_SubComponent_And_Feed_Content_Section")) {
            // return DataUtil.getData(xls, "TemplateName", testSheetName);
            return GDriveSpreedSheetUtil.getTestDataFromExcel("Verify_PreFeeded_EditoriaQuotes_Add_SubComponent_And_Feed_Content_Section", testSheetName);

        } else if (method.getName().equals("Verify_PreFeeded_GridMediaFolder_Add_SubComponent_And_Feed_Content_Section")) {
            // return DataUtil.getData(xls, "TemplateName", testSheetName);
            return GDriveSpreedSheetUtil.getTestDataFromExcel("Verify_PreFeeded_GridMediaFolder_Add_SubComponent_And_Feed_Content_Section", testSheetName);

        } else if (method.getName().equals("Verify_PreFeeded_FeaturedBrand_Add_SubComponent_And_Feed_Content_Section")) {
            // return DataUtil.getData(xls, "TemplateName", testSheetName);
            return GDriveSpreedSheetUtil.getTestDataFromExcel("Verify_PreFeeded_FeaturedBrand_Add_SubComponent_And_Feed_Content_Section", testSheetName);
