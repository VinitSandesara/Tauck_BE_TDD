...
public class Editorial_PDF11 extends testBase {
    ...
    public void mapDataSourceWithFrontEndControls() throws Exception {
        ...
        editorialTemplateControls editorialtemplateControl = sitecore.launchSitecore()
                ...
                .navigateToWhichTauckNodeForMappingDataSourceWithFrontEndControl(navigateToNode.EDITORIAL_PADF11)
    ...
    @Test
    public void createEditorialSubTemplate_PDF11() throws Exception {
        ...
        sitecore.launchSitecore()
                ...
                .rightClickInsertTemplateOrComponent(rightClickInsert.EDITORIAL_SUB_TEMPLATE_PDF11)
                .switchToContentIframeDialog(Config.PARENT_FRAME, Config.CHILD_FRAME);


        // Delete pre-added FE Controls before mapping datasource.
        Object mapControlswithDataSource = sitecore.createTemplateOrTemplateComponent(whatIsTheComponentName.EDITORIAL_SUB_TEMPLATE_PDF11, mapControlWithDataSource.class.getSimpleName());
   ...
   //@Test( dataProvider = "readTestData")
    public void verifyPreFeededSubCategoriesInsideTemplate(Hashtable<String, String> data) throws InterruptedException, IOException {
        ...
        sitecore
                .login()
                .goToContentEditorIfNotKickOffUser()
                .verifyPreFeededSubComponent(navigateToNode.EDITORIAL_PADF11, Arrays.asList(data.get("CategoriesList").split("\\|")));

    }


    @Test( dependsOnMethods = {"createEditorialSubTemplate_PDF11", "verifyPreFeededSubCategoriesInsideTemplate"}, dataProvider = "readTestData")
    // @Test( dataProvider = "readTestData")
    public void fill_Content_Of_Editorial_Title_Component(Hashtable<String, String> data) throws InterruptedException, IOException {
        ...
        sitecore
                .login()
                .goToContentEditorIfNotKickOffUser()
                .navigateToWhichTauckNode(navigateToNode.EDITORIAL_PADF11 , "/" + data.get("preFeededComponentName"))
